...
public class AppPrincipal {
    public static void main(String[] args) {
        ...
        System.out.println("\n ***** Inicio Cadastros ***** \n");
        cadastrarTransacao(new CompraDebito(new Data(1, 11, 2022), "Posto de Gasolina", -150f, bb));
        cadastrarTransacao(new CompraDebito(new Data(1, 11, 2022), "Loja Roupas", -100f, nb));
        cadastrarTransacao(new CompraCreditoAvista(new Data(1, 10, 2022), "Mercado", -142.22f, nb));
        cadastrarTransacao(new CompraCreditoParcelada(new Data(1, 5, 12), "Compra online", -500, bb, 10));
        cadastrarTransacao(new CompraCreditoParcelada(new Data(1, 5, 12), "Compra online", -500, nb, 10));
